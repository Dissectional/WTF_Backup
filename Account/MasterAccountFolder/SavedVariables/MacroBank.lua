	...
	["global"] = {
		["Macros"] = {
			...
			}, -- [1]
			{
				...
				{
					{
						"Bear - Feral tanking", -- [1]
						"Bear", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
						"/castsequence reset=1/alt Faerie Fire (Feral),Feral Charge,null\n/castsequence Lacerate,Lacerate,Lacerate,Mangle,Pulverize\n/castsequence Maul,Swipe(Bear Form),Thrash\n/castsequence Barkskin,Berserk,Frenzied Regeneration,Survival Instincts\n/startattack", -- [4]
					}, -- [1]
					{
						"Boomkin - Modifier for Wrath", -- [1]
						"Boomkin", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
						"/castsequence [mod]Wrath;reset=target/4 Insect Swarm,Moonfire,Starfire,Starfire,Starfire,Starfire\n/cast Starsurge\n/use 13\n/use 14\n/petattack", -- [4]
					}, -- [2]
					{
						"Cat dungeon - Feral attack behind", -- [1]
						"Cat", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
					...
					{
						"Cat farming - Feral frontal attack", -- [1]
						"Cat 2", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
			...
			}, -- [2]
			{
				...
				{
					{
						"Beast - Modifier for Arcane Shot", -- [1]
						"Beast", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
			...
			}, -- [3]
			{
				...
				{
					{
						"Arcane - Modifier for Missiles", -- [1]
						"Arcane", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
			...
			}, -- [5]
			{
				...
				{
					{
						"Any spec - Smart buffing macro", -- [1]
						"Multiform buff", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
						"/castsequence [nostance] Shadowform\n/castsequence [stance:0,@player] reset=5 Power Word: Fortitude, Shadow Protection, Inner Will,.\n/castsequence [stance:1,@player] reset=5 Vampiric Embrace, Power Word: Fortitude, Shadow Protection, Inner Fire,.", -- [4]
					}, -- [1]
					{
						"Any spec - Spam DoTs to multiple enemies", -- [1]
						"Multi DoT", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
						"/targetenemy\n/cast [mod,harm,nodead]Vampiric Touch;[harm,nodead]Shadow Word: Pain", -- [4]
					}, -- [2]
					{
						"Shadow - W/o talents on Mind Blast", -- [1]
						"Shadow", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
					...
					{
						"Shadow PVP - With talents on Mind Blast", -- [1]
						"Shadow PVP", -- [2]
						"Interface\\Icons\\INV_Misc_QuestionMark", -- [3]
