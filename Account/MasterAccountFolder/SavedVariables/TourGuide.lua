	...
	["char"] = {
		...
		["Mittens - PrimalWoW (Progressive)"] = {
			["completion"] = {
				...
				["Mulgore (1-12)"] = 1,
				["No Guide"] = 0,
				["vvvvvvv Flaw's Guides vvvvvvv"] = 0,
				["The Barrens (12-20)"] = 0.5925925925925926,
				["Tirisfal Glades (1-12)"] = 1,
			},
			["trackquests"] = false,
			["mapnotecoords"] = false,
			...
			["turnins"] = {
				...
				["The Lunar Festival (80+)"] = {
					["Brightspear the Elder"] = true,
					["Orgrimmar@3@"] = true,
					["Omen@5@"] = true,
					["Skygleam the Elder"] = true,
					["Durotar@13@"] = true,
					["Darkshore@10@"] = true,
					["Windtotem the Elder"] = true,
					["Riversong the Elder"] = true,
					["Darkhorn the Elder"] = true,
					["Moonglade@4@"] = true,
					["Dalaran@2@"] = true,
					["Felwood@8@"] = true,
					["Moonwarden the Elder"] = true,
					["Orgrimmar@12@"] = true,
		...
		["Wafflestomp - PrimalWoW (Progressive)"] = {
			["completion"] = {
				["Durotar (1-12)"] = 1,
				["The Barrens (12-20)"] = 0.09230769230769231,
				["Tirisfal Glades (1-12)"] = 0,
				["Mulgore (1-12)"] = 1,
				["Non-Icecrown [Gold Only] (80-N)"] = 0,
				["The Lunar Festival (80+)"] = 0,
			},
			["trackquests"] = false,
			["mapnotecoords"] = false,
			["turnins"] = {
		...
		["Pastafarian - TrueWoW"] = {
			["turnins"] = {
				...
				["Eversong Woods (1-13)"] = {
					["Training?@15@"] = true,
					["Falconwing Square@5@"] = true,
					["Silvermoon City@12@"] = true,
					["Class Quests?@14@"] = true,
					["Suntouched Special Reserve@13@"] = true,
					["Bundle of Fireworks@18@"] = true,
					["Fairbreeze Village@9@"] = true,
					["I CAN HAS PELTS?@10@"] = true,
					["Springpaw Appetizers@16@"] = true,
					["Fairbreeze Village@17@"] = true,
				},
				["Ghostlands (13-20)"] = {
					["Tranquillien@1@"] = true,
					["Tranquillien@2@"] = true,
			...
			["completion"] = {
				...
				["The Barrens (12-20)"] = 0,
				["Eversong Woods (1-13)"] = 1,
				["Durotar (1-12)"] = 0.9532710280373832,
			},
			["currentguide"] = "Ghostlands (13-20)",
			["hearth"] = "Tranquillien",
		},
